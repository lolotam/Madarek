...
export const IMAGE_SLOTS: readonly ImageSlot[] = [
  ...
  },
  {
    ...
    prompt: `${SUBJECT_DIRECTION} Local textbook references: GRADE-8/FIRST-TERM/SCIENCE/علوم.pdf and GRADE-8/FIRST-TERM/SCIENCE/علوم/علوم-1.jpg. Scene: a compact white microscope, a flask of clear water, and a small seedling. Do not copy public/images/science-discovery.png; this is a new subject-card frame.`,
    usage: "Grade 8 subject card for العلوم on /grade/8",
    ready: true,
  },
  {
    id: "quran",
  ...
  },
  {
    ...
    width: 768,
    height: 768,
    alt: "مجسم كرة أرضية وبوصلة على مكتب دراسة",
    prompt: `${SUBJECT_DIRECTION} Local folder reference: GRADE-8/FIRST-TERM/SOCIAL STUDIES/ثامن_اجتماعيات_حل_الكتاب_للفصل_الاول_2025.pdf (2025 solution booklet; no 2026-2027 student cover was inspected). Scene: a small plain classroom desk globe with no printed names beside a brass compass and a closed notebook on a wooden desk. No country names, no labels.`,
